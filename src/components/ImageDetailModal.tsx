        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-[1100px] mx-auto">
            <div
              ...
              style={{ height: 'min(76vh, 820px)' }} // fills the panel nicely
            >
              {imgs.map((src, i) => (
                <div key={i} className="relative w-full h-full border border-[#2A2B2E] overflow-hidden">
                  {/* keep portrait feel: fill cell while preserving aspect */}
